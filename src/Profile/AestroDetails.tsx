  ...
  >
    ...
    >
      <form onSubmit={submitHandler} className="mx-2 my-2">
        <small className="mt-0 text-break font-italic" style={{marginLeft: "78%" ,     fontStyle: "italic"}}><small className="text-danger">*</small>Mandatory Fields</small>
        <p
          className="fs-3 text-break
"
          style={{ color: "#6E6E6E" }}
        >
          Aestrological Informations<small className="p-3 text-sm text-break" style={{fontSize:"15px"}}>( You can create your free horoscope on PerfectMatch )</small>
        </p>
       <Row>
           <Col>
...
<input type="date" />
           ...
           <Col>
           <label htmlFor="">Time Of Birth</label><br />
            <select name="" id="">
