...
const PersonalInfo = () => {
  ...
  const annualfamilyincome2Handler = (e:React.ChangeEvent<HTMLSelectElement>)=> {
    if(!(e.target.value === "")) {
  ...
  const submitHandler = (e: any) => {
    ...
    // }
    // complexionHandler(R)
    if (complexions === "" || bodytype === "" || bloodgroup == "" || occupation == "" || empolyedin == "" || currency == "" || annualincome == "") {
 ...
 "
          ...
          <div className="row">
            ...
            <div className="col">
              ...
              <select
                ...
                className="form-control text-dark mt-1 rounded-2 border-secondary form-select "
              >
                <option hidden value="one">Select Any One</option>
                <option>A+</option>
                <option>B+</option>
                <option>AB+</option>
                <option>AB-</option>
          ...
          <Row className="border border rounded-2 mx-1">
            <Col className="mt-3">
              ...
              >
                <option value="one" hidden>Select Any One</option>
          ...
          <Row className="" style={{ height: "250px" }}>
            ...
            {error2 ? <span className="text-danger">plase tell us about your family</span> : null}
              <label htmlFor="">
          ...
          <Row>
              {error3 ? <span className="text-danger">Please Select Below Mentio Fields</span> : null}
            <Col className="mt-3">
              <label>
                Currency <span className={classes.compalsory}>*</span>
                <br />
