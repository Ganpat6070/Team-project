 ...
 "
          ...
          <div className="row">
            <div className="col-lg-4">
              {/* <div className="form-group"> */}
                ...
                <select ref={Height}  className="form-control text-dark mt-1 rounded-2 border-secondary form-select ">
            ...
            <div className="col">
              ...
              <select ref={Weight} className="form-control text-dark mt-1 rounded-2 border-secondary form-select ">
              <option hidden>Select Any One</option>
                <option>A+</option>
                <option>B+</option>
                <option>AB+</option>
          ...
          <Row>
            <Col className="mt-3">
              ...
              <select ref={MStatus} className="form-control text-dark mt-1 rounded-2 border-secondary form-select">
              <option hidden>Select Any One</option>
          ...
          <div className="px-2 my-3" style={{backgroundColor:"#E5E4E2" , width:"100%", height:"25px", borderRadius:"2px" ,}}>Astro Details</div>
...
{/*               
           ...
           {/* <label htmlFor="">
              ...
              <select style={{ height: "40%"}} ref={Religion} className="form-control text-dark mt-1 mb-4 rounded-2 border-secondary form-select">
                <option hidden>Select Any One</option>
                <option>Sun</option>
                <option>Venus</option>
                <option>Moon</option>
          ...
          {/* <div className="row"> */}
            <div className="col mt-3">
              ...
              {/* <input
                ...
                className="form-control text-dark mt-1 rounded-2 border-secondary"
              /> */}
              <textarea name="" id="" className="w-100 p-4 h-1 " style={{width:"800"}}></textarea>
              <p style={{color:"#6E6E6E" , fontSize:"small" , fontStyle:"italic"}}>
          ...
          {/* </div> */}
            ...
            <Col  className="mt-3">
              <label htmlFor="" className="pt-3">Family Type
                <br />
              </label>
              <select style={{ height: "15%"}} ref={Religion} className="form-control text-dark mt-1 mb-4 rounded-2 border-secondary form-select">
                <option hidden>Select Any One</option>
              ...
              <label htmlFor="" className="pt-3">Family Status
                <br />
              </label>
              <select style={{ height: "15%"}} ref={Religion} className="form-control text-dark mt-1 mb-4 rounded-2 border-secondary form-select">
                <option hidden>Select Any One</option>
         ...
         <div className="col mt-3">
          ...
          {/* </div> */}
          <Link to="\" >
          <button className="btn btn-light btn-outline-secondary btn-xl mt-2" type="button" onClick={submitHandler}>Save and Continue</button>
          </Link>
        </form>
      </div>
    </div>
